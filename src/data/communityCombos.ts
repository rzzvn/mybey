...
export const BLADE_NAME_MAP: Record<string, string> = {
  ...
  // Identity mappings — used by community combos that are already the canonical name
  "Blast": "Blast",
...
export const commonCombos: CommunityCombo[] = [
  // Defense-Stamina
  {
    ...
    ratchets: ["6-60", "7-60", "9-60", "9-70", "6-70", "7-70"], bits: ["H", "UN", "FB", "F", "W"],
  ...
  },
  {
    ...
    ratchets: ["3-60", "9-60"], bits: ["B", "FB", "LO"],
  ...
  },
  {
    ...
    ratchets: ["7-60", "9-60"], bits: ["V", "H", "FB", "LO"],
  ...
  },
  {
    ...
    ratchets: ["1-60", "1-50", "1-70"], bits: ["W", "H"],
  ...
  // Beginner
  {
    ...
    ratchets: ["3-60", "7-60"], bits: ["H", "J", "S", "R", "LR", "LF", "F", "K", "T", "U"],
  ...
  },
  {
    ...
    ratchets: ["1-60", "3-60", "7-60"], bits: ["F", "R", "LR", "K"],
  ...
  // Attack
  {
    ...
    ratchets: ["1-60", "1-50", "7-60"], bits: ["F", "H", "S", "R", "LR"],
  ...
  },
  {
    ...
    ratchets: ["2-60", "6-60"], bits: ["S", "H", "K", "T", "F"],
  ...
  },
  {
    ...
    ratchets: ["1-60", "5-60", "7-60"], bits: ["H", "B", "J", "R", "LR"],
  ...
  },
  {
    ...
    ratchets: ["1-60", "3-60"], bits: ["F", "R", "LR"],
