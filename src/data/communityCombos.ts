...
export const commonCombos: CommunityCombo[] = [
  // Defense-Stamina
  {
    blade: "Blast (CX-07)", bladeCode: "CX-07",
  ...
  {
    blade: "Knight Shield (BX-04)", bladeCode: "BX-04",
  ...
  // Attack
  {
    blade: "Flash Strike (CX-13)", bladeCode: "CX-13",
    notes: "暫時最重上蓋。F高度較低減風阻。H增加重量。S攻擊輔助刃。1-60/1-50配合單點打擊。7-60增加重量。R/LR持久較好攻擊軸。",
    source: "Day16", category: "Attack"
  },
  {
    blade: "Arc Light (CX-02)", bladeCode: "CX-02",
    notes: "表面圓滑有撞擊力。S攻擊輔助刃。H增加重量。2-60識復活配合2點打擊。6-60提升迴旋增加尾速。K機動高持久好。T是K下位。F新手友好攻擊軸。",
    source: "Day14", category: "Attack"
  },
  {
    blade: "Whale Wave (BX-26)", bladeCode: "BX-26",
    notes: "較大逆刃，重量優秀。M-85配合上盤5點。5-60配合外拋性強。B反擊流持久好。H對付左迴旋有優勢。",
    source: "Day11", category: "Attack"
  },
  {
    blade: "Tyranno Beat (UX-10)", bladeCode: "UX-10",
  ...
  {
    blade: "Stone (CX-11)", bladeCode: "CX-11",
