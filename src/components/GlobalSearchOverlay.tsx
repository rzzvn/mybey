...
export default function GlobalSearchOverlay({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[10vh] bg-black/30 backdrop-blur-sm">
      <div
        ref={overlayRef}
        className="w-[95vw] max-w-xl bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden"
      >
        {/* Search input */}
